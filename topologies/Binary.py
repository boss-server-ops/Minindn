...
def generate_conf(k):
    ...
    for parent_layer in range(k-1):
        ...
        for x in range(num_parents):
            ...
            links.append(f"{parent_name}:{child1} bw=100 delay=0 max_queue_size=10000 loss=0")
            links.append(f"{parent_name}:{child2} bw=100 delay=0 max_queue_size=10000 loss=0")
