...
namespace ndn::chunks
{
    ...
    enum DATA_TYPE
    {
        DATA_TYPE_METADATA = 1,
        DATA_TYPE_TOPLAYER,
        DATA_TYPE_LASTLAYER_30,
        DATA_TYPE_LASTLAYER_50,
        DATA_TYPE_LASTLAYER_75,
        DATA_TYPE_LASTLAYER_100
    };
    ...
    private:
         ...
         */
        void
        sendInterest(DATA_TYPE datatype);
         ...
         */
        void
        checkSendNext(DATA_TYPE datatype);
        ...
        std::unordered_map<DATA_TYPE, TypeInfo> m_typeInfo; ///< keeps all the internal information
